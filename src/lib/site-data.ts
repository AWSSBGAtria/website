export const focusAreas = [
  {
    ...
    description:
      "Structured workshops on AWS core services, deployment patterns, and real-world architecture tradeoffs.",
  },
  {
    title: "Builder Culture",
    description:
      "A sharper student community with showcases, hackathons, and critique that pushes projects beyond demo quality.",
  },
  {
    title: "Certification Paths",
    description:
      "Study sprints, guided practice, and peer support for students targeting official AWS credentials.",
  },
];
