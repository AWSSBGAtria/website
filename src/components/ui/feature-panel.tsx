...
export function FeaturePanel({
  ...
  return (
    <div
      className={cn(
        "geometric-block p-6 group transition-all hover:bg-[#7c5aed]/5",
        className,
      )}
    >
      <div className="flex flex-col items-start gap-6">
        ...
        <div>
          <h3 className="font-display text-2xl font-black uppercase leading-none tracking-tight text-[#1a1a1b]">
            {title}
          </h3>
